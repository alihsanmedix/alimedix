      ...
      <div>
        <MDBJumbotron fluid>
          <MDBContainer className="text-white text-center mt-5">
            <h1 className="h1-responsive display-2">AliMedix Health Information Directory</h1>
            <hr />

            <p className="display-5 mx-5 mb-5">
              Welcome! At AliMedix, we tend to solve health care problems using digital solution.
            </p>
        ...
        <MDBContainer>
          <MDBRow>
            <MDBCol md="12" className="mt-4">
              <h2 className="text-center my-5 font-weight-bold">Get AliMedix By team_232! #weRock</h2>
            </MDBCol>
            <MDBCol md="6">
              <p className="mb-1">
                ...
                <MDBCard cascade className="my-3 grey lighten-4">
                  ...
                  <MDBCardBody cascade className="text-center">
                    <MDBCardTitle>
                      ...
                      <strong>Health Technicians</strong>
                    </MDBCardTitle>
                    <MDBCardText>
                      lorem ipsum dalum lorem ipsum dalum ipsum lorem ipsum dalum lorem ipsum dalum ipsum lorem ipsum
                      dalum lorem ipsum dalum ipsum.
